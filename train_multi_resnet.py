...
parser.add_argument(
    '--data_dir', type=str, default='./tf_records/',
    help='The directory where the input data is stored.')

parser.add_argument(
    '--model_dir', type=str, default='./hvd_saved_model',
...
def main():
    ...
    # srini: adjust learning rate based on number of GPUs
    scaled_lr = FLAGS.lr * hvd.size() 
